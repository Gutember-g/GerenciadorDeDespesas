...
export function ProfilePage() {
  ...
  return (
    <div className="space-y-8 max-w-4xl animate-in fade-in duration-300">
      <div>
        <h2 className="text-3xl font-bold tracking-tight text-slate-900 dark:text-white">Meu Perfil</h2>
        <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">
          Gerencie seus dados pessoais, estilo de avatar e segurança da conta.
        </p>
      </div>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full rounded-xl border border-slate-200 dark:border-white/10 bg-slate-55 dark:bg-[#07111f] px-4 py-3 pr-10 text-sm text-slate-900 dark:text-white outline-none focus:border-blue-500"
                  />
                  <button
                    type="button"
                    onClick={() => setShowPass(!showPass)}
                    className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-805 dark:hover:text-white"
                  >
