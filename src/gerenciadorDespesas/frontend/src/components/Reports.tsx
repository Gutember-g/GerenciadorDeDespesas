              ...
              >
                ...
                >
                  ...
                  <div className="flex items-center gap-4 text-right">
                    <div>
                      <p className="text-sm font-bold text-slate-800 dark:text-slate-200">R$ {group.total.toFixed(2)}</p>
                        ...
                        <div key={sub.name} className="flex items-center justify-between px-6 py-4 hover:bg-slate-50 dark:hover:bg-white/5 transition-colors">
                          ...
                          <div className="flex items-center gap-6">
                            ...
                            <div className="text-right min-w-[90px]">
                              <p className="text-sm font-bold text-slate-800 dark:text-slate-100">R$ {sub.total.toFixed(2)}</p>
